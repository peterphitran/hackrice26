...
from lou.telemetry.correlation import correlate_runtime_name
...
def test_otlp_outage_is_bounded_and_factory_never_enables_network_by_default(monkeypatch) -> None:
    assert isinstance(
        build_telemetry(
